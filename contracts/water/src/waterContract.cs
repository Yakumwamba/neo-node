...
namespace water
{
    [DisplayName("Brian.waterContract")]
    [ManifestExtra("Author", "Brian Lemba")]
    [ManifestExtra("Email", "brian@lemba.com")]
    [ManifestExtra("Description", "Describe your contract...")]
    public class waterContract : SmartContract
    {
        private static StorageMap ContractStorage => new StorageMap(Storage.CurrentContext, "waterContract");
